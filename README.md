...
[**FistashkinBot**](https://github.com/Yuuki.git) — это небольшой бот с кучкой команд и своей экономикой. Он работает на слеш командах, что его использование окажется куда удобнее.
